...
const NewsLetter = () => {
    return (
        <div className="flex flex-col items-center max-w-5xl lg:w-full rounded-2xl px-4 py-12 md:py-16 mx-2 lg:mx-auto my-30 bg-gray-900 text-white">
            <Title title="Mantente Informado" subTitle="Únete a nuestro boletín y sé el primero en descubrir nuevos destinos, ofertas exclusivas e inspiración para viajar."/>
