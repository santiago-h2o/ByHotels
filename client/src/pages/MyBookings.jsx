...
const MyBookings = () => {
    ...
    return (
        <div className='py-28 md:pb-35 md:pt-32 px-4 md:px-16 lg:px-24 xl:px-32'>
            <Title title='Mis Reservas' subTitle='Gestiona fácilmente tus reservas de hotel pasadas, actuales y futuras en un solo lugar.
Planifica tus viajes sin complicaciones con solo unos pocos clics.' align='left' />

            <div className='max-w-6xl mt-8 w-full text-gray-800'>

                <div className='hidden md:grid md:grid-cols-[3fr_2fr_1fr] w-full border-b border-gray-300 font-medium text-base py-3'>
                    <div className='w-1/3'>Hoteles</div>
                    <div className='w-1/3'>Fecha y horarios</div>
                    <div className='w-1/3'>Pago</div>
                </div>
